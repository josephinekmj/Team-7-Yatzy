        ...
        static void Main(string[] args)
        {
            ...
            for (int rounds = 0; rounds < 30; rounds++) // 15 runder for hver spiller
            {
                ...
                else if (player1 == false) // Anden spillers tur, fordi 'player1' bool er false
                {
                    ...
                    if (!player1) // Spiller 2's tur, fordi 'player1' bool er false
                    {
                        for (int p2Roll = 0; p2Roll < 3; p2Roll++) // 3 kast for første spiller
                        {
                            ...
                            Console.WriteLine("Spiller 2 kaster sine terninger");
                            ...
                            Console.WriteLine($"\n{p2Roll + 1}. Terningekast: {terning1}, {terning2}, {terning3}, {terning4}, {terning5}");
                            Console.WriteLine("\nKombinationer:");
                                ...
                                case "2": // Hvis spilleren vælger at skrive sin kombination på scoreboardet (vælger 2 i ovenstående menuen)
                                    ...
                                    switch (scoreboardChoice) // Her kontrolleres for hvad spilleren vælger - Dvs. hvilken position på scoreboardet pointene skal på
                                    {
                                        ...
                                        case "B":
                                            ...
                                            if (toPar)
                                                if ((terning1 == terning2) && (terning3 == terning4) ||
                                                    (terning1 == terning3) && (terning2 == terning4) ||
                                                    (terning1 == terning4) && (terning2 == terning3))
                                                    P2toPar = (terning1 + terning2 + terning3 + terning4);
                                                else if ((terning1 == terning2) && (terning3 == terning5) ||
                                                        (terning1 == terning3) && (terning2 == terning5) ||
                                                        (terning1 == terning5) && (terning2 == terning3))
                                                    P2toPar = (terning1 + terning2 + terning3 + terning5);
                                                else if ((terning1 == terning2) && (terning4 == terning5) ||
                                                        (terning1 == terning4) && (terning2 == terning5) ||
                                                        (terning1 == terning5) && (terning2 == terning4))
                                                    P2toPar = (terning1 + terning2 + terning4 + terning5);
                                                else if ((terning2 == terning3) && (terning4 == terning5) ||
                                                        (terning2 == terning4) && (terning3 == terning5) ||
                                                        (terning2 == terning5) && (terning3 == terning4))
                                                    P2toPar = (terning2 + terning3 + terning4 + terning5);
                                                else
                                                    P2toPar = 0;
                                            break;
                                        case "C":
                                        ...
                                        case "G":
                                            player1 = true;
                                            if (fuldtHus)
                                                P2fuldtHus = terning1 + terning2 + terning3 + terning4 + terning5;
                                            else
                                                P2fuldtHus = 0;
                                            break;
                                        case "H":
                                            player1 = true;
                                            P2chance = terning1 + terning2 + terning3 + terning4 + terning5;
                                            break;
                                        case "I":
                                            player1 = true;
                                            if (yatzy)
                            ...
                            if (player1 == true) // Hvis player1 er falsk bryder den ud af den ud af spilleres 3 kast ('for' loop)
                                break;

                            if (p2Roll == 2) // Kontrollere at spilleren ikke bruger flere kast end 3 ---- p1Roll 0, 1, 2 (3 kast) ellers sætter den player1 til falsk
                            {
                                player1 = true;
                                break;
                            }
